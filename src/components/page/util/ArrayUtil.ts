 ...
 * @returns [] | [1, 2, 3, ...] | "" | "1,2,3,..."
 */
export function entityArrayToFiledArray<R>(array: any[] | undefined, field: string, type: string = defaultType, delimiter: string = defaultDelimiter): Array<R> | string {
  switch (type) {
    case "array":
 ...
 * @returns [] | [1, 2, 3, 4, 5, ...]
 */
export function entityArrayTransformFieldArray<R>(array: any[] | undefined, field: string): Array<R> {
 ...
 * @returns "" | "1,2,3,4,5..."
 */
export function entityArrayTransformFieldArrayString(array: any[] | undefined, field: string, delimiter: string = defaultDelimiter): string {
  if (!array || !array.length) {
    return "";
  }
 ...
 * @param delimiter 分隔符
 */
export function toArray(a: Array<any> | string | undefined, type: string = defaultType, delimiter: string = defaultDelimiter): Array<any> {
 ...
 * @returns [] | [1, 2, 3, 4, 5, ...]
 */
export function toArrayformString(arrayString: string | undefined, delimiter: string = defaultDelimiter): Array<string> {
